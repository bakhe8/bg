"""
Review persistence utilities.

This module mirrors the behaviour of ``main.api.review_store`` so legacy
Blueprints can keep working while new code imports from
``BGLApp_Refactor.core.review``.
"""
...
REVIEW_DIR = LEGACY_PATHS.review_dir
